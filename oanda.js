/*
	...
	This is a sample implementation of UDF-compatible datafeed wrapper for Oanda (historical data).
...
requestProcessor.oandaCache = requestProcessor._oandaCache();
...
var firstPort = process.env.OANDA_UDF_PORT || 8888;
